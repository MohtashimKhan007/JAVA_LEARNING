...
import in.strikes.springTestingDemo.controller.ProductControllerTest__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("in.strikes.springTestingDemo.controller.ProductControllerTest", () -> new ProductControllerTest__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("in.strikes.springTestingDemo.controller.ProductControllerTest", ProductControllerTest__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
